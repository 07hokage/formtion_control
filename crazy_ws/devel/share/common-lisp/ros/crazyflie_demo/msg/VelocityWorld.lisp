...
(cl:defmethod cl:initialize-instance :after ((m <VelocityWorld>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityWorld)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_demo-msg:<VelocityWorld> is deprecated: use crazyflie_demo-msg:VelocityWorld instead.")))
...
(cl:defmethod vel-val ((m <VelocityWorld>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_demo-msg:vel-val is deprecated.  Use crazyflie_demo-msg:vel instead.")
  (vel m))
