...
(cl:in-package crazyflie_demo-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Hover>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hover)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_demo-msg:<Hover> is deprecated: use crazyflie_demo-msg:Hover instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Hover>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_demo-msg:header-val is deprecated.  Use crazyflie_demo-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'vx-val :lambda-list '(m))
(cl:defmethod vx-val ((m <Hover>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_demo-msg:vx-val is deprecated.  Use crazyflie_demo-msg:vx instead.")
  (vx m))

(cl:ensure-generic-function 'vy-val :lambda-list '(m))
(cl:defmethod vy-val ((m <Hover>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_demo-msg:vy-val is deprecated.  Use crazyflie_demo-msg:vy instead.")
  (vy m))

(cl:ensure-generic-function 'yawrate-val :lambda-list '(m))
(cl:defmethod yawrate-val ((m <Hover>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_demo-msg:yawrate-val is deprecated.  Use crazyflie_demo-msg:yawrate instead.")
  (yawrate m))

(cl:ensure-generic-function 'zDistance-val :lambda-list '(m))
(cl:defmethod zDistance-val ((m <Hover>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_demo-msg:zDistance-val is deprecated.  Use crazyflie_demo-msg:zDistance instead.")
  (zDistance m))
